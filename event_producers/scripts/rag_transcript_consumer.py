...
class TranscriptRAGConsumer:
    ...
    def __init__(
        ...
        rabbitmq_user: str = "delorenj",
        rabbitmq_password: str = "MISSING_PASSWORD",
...
def main():
    ...
    consumer = TranscriptRAGConsumer(
        ...
        rabbitmq_user=os.getenv("RABBITMQ_USER", "delorenj"),
        rabbitmq_password=os.getenv("RABBITMQ_PASSWORD", "MISSING_PASSWORD"),
