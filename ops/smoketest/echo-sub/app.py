#!/usr/bin/env python3
"""Minimal Dapr subscriber app for the Dapr subscribe smoke test.
...
Configuration via environment:
  ...
  SUBSCRIBE_TOPIC      -- Topic (and NATS subject) to subscribe to
                          (default: bloodbank.evt.system.heartbeat.received)
...
SUBSCRIBE_TOPIC = os.environ.get("SUBSCRIBE_TOPIC", "bloodbank.evt.system.heartbeat.received")
